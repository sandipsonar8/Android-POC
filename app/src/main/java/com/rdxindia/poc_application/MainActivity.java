...
public class MainActivity extends AppCompatActivity {
    ...
    private Button galleryButton; // New gallery button
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        galleryButton = findViewById(R.id.galleryButton); // Initialize gallery button
        ...
        btnRetake.setOnClickListener(v -> {
            ...
            galleryButton.setVisibility(View.GONE); // Hide gallery button
    ...
    private void checkAndRequestPermissions() {
        ...
        if (!requiredPermissions.isEmpty()) {
            ...
            initializeCamera();
            initializeSpeechRecognizer();
            startListeningService(); // Start the service if permissions are granted
        }
    }

    private void startListeningService() {
        Intent serviceIntent = new Intent(this, ListeningService.class);
                    ...
                    if (matches != null) {
                        for (String phrase : matches) {
                            if (phrase.toLowerCase().contains(keyword)) {
                                if (isPreviewVisible) {
                                    // If the photo preview is visible, switch back to the live camera preview
                                    photoPreview.setVisibility(View.GONE);
                                    btnRetake.setVisibility(View.GONE);
                                    galleryButton.setVisibility(View.GONE); // Hide gallery button
                                    isPreviewVisible = false;
                                    restartCameraAndListening(); // Restart the camera and listening
                                } else {
                                    takePhoto(); // Take a photo if the preview is not visible
                                }
                                break;
                            }
                        }
                    ...
                    public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                        runOnUiThread(() -> {
                            ...
                            if (outputFileResults.getSavedUri() != null) {
                                ...
                                // Set the captured photo to the preview ImageView
                                photoPreview.setImageURI(photoUri);
                                photoPreview.setVisibility(View.VISIBLE);
                                btnRetake.setVisibility(View.VISIBLE);
                                galleryButton.setVisibility(View.VISIBLE); // Show gallery button
